...
class VaccinationRecords extends StatefulWidget {
  const VaccinationRecords({Key? key}) : super(key: key);
...
class _VaccinationRecordsState extends State<VaccinationRecords> {
  ...
  final TextEditingController _dateDialogController = TextEditingController();
  ...
  void _showPopup() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Enter Vaccine Details'),
          content: SizedBox(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  DataTable(
                    columns: const [
                      DataColumn(label: Text('Vaccination Type')),
